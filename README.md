...
An unoffical forge version can be found [here](https://www.curseforge.com/minecraft/mc-mods/orbital-railgun-reforged). (1.20 only)

An unoffical sound effect addon can be found [here](https://modrinth.com/mod/orbital-railgun-sounds). (1.20 only)

## Description

## THIS IS NOT THE OFFICIAL VERSION, this is a port to a newer version.

## THE OFFICIAL ONE IS BY MISHKIS and can be found [here](https://modrinth.com/mod/orbital-railgun).

If you've ever wanted to destroy large swathes of land in an instant while having no regard for the local fauna and wildlife present, then our new invention of the Orbital Railgun may interest you. By harnessing the power of a star, you are able to communicate directly to our rapid-response railgun satalite, allowing for quick and easy access to absolute destruction. Simply aim your Orbital Railgun and fire, and within half a minute you will have caused an ecological disaster, but at least the area is clear now!. This version does NOT have any audio, please port that mod youself.
